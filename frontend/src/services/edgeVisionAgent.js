            ...
            reader.onload = (e) => {
                ...
                img.onload = async () => {
                    try {
                        ...
                        // Gate 2: Edge AI Validation (97% Confidence & Margin Floor)
                        // Requires top-1 confidence >= 97% with margin >= 60% before proceeding to automated agronomic recommendation.
